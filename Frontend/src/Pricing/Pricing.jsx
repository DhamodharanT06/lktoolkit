...
import './Pricing.css';
import pay from '../Utility/razorpay';
...
const Pricing = () => {
  ...
  const keyId = window.razorpayKeyId;
        ...
        <div className="pricing-plan">
          ...
          <div className="plan-cta">
            <button 
              ...
              onClick={() => pay(59900, csrfToken, keyId, refreshSubscription)}
            >
              Choose Basic
            </button>
          </div>
        ...
        <div className="pricing-plan special">
          ...
          <div className="plan-cta">
            <button 
              ...
              onClick={() => pay(89900, csrfToken, keyId, refreshSubscription)}
            >
        ...
        <div className="pricing-plan">
          ...
          <div className="plan-cta">
            <button 
              ...
              onClick={() => pay(129900, csrfToken, keyId, refreshSubscription)}
            >
              Choose Premium
            </button>
          </div>
