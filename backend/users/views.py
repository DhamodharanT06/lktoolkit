    ...
    def get(self, request):
        ...
        try:
            ...
            if subscription:
                ...
                # Optional: Auto-expire subscriptions if needed
                ...
                return Response({
                    ...
                    'submissions_remaining': subscription.submissions_remaining,
                    'subscription_id': subscription.id
                })

            print("DEBUG: No subscription record found")
            return Response({
                'tier': 'free',
                'submissions_remaining': 1  # Default for free plan
            })
